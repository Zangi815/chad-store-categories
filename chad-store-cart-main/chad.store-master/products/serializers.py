...
from products.models import Review, Product, FavoriteProduct, ProductTag, Cart, ProductImage
...
class FavoriteProductSerializer(serializers.ModelSerializer):
    ...
    def create(self,validated_data):
        ...
        if not created:
            raise serializers.ValidationError('product with givem id is already in favorites')
